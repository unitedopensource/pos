    ...
    <div ref="wrap" :class="['vue-slider-component', flowDirection, disabledClass, { 'vue-slider-has-label': piecewiseLabel }]" v-show="show" :style="wrapStyles" @click="wrapClick">
        <div ref="elem" aria-hidden="true" class="vue-slider" :style="[elemStyles, bgStyle]">
            <template v-if="isRange">
                <div ref="dot0" :class="[tooltipStatus, 'vue-slider-dot']" :style="[dotStyles, sliderStyles[0]]" @mousedown="moveStart($event, 0)" @touchstart="moveStart($event, 0)">
                ...
                <div ref="dot1" :class="[tooltipStatus, 'vue-slider-dot']" :style="[dotStyles, sliderStyles[1]]" @mousedown="moveStart($event, 1)" @touchstart="moveStart($event, 1)">
            ...
            <template v-else>
                <div ref="dot" :class="[tooltipStatus, 'vue-slider-dot']" :style="[dotStyles, sliderStyles]" @mousedown="moveStart" @touchstart="moveStart">
    ...
    setTransform(val) {
      ...
      let translateValue =
        this.direction === "vertical"
          ? `translateY(${value}px)`
          : `translateX(${value}px)`;
      let processSize = `${this.currentSlider === 0
        ? this.position[1] - val
