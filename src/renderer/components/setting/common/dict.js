var Dictionary = function (key) {
    let abbreviation = {
        ...
        BBC:[{zhCN:"笨笨鸡",usEN:"Bourbon Chicken"}],
        CT: [{ zhCN: "鸡串", usEN: "Chicken Teriyaki" }],
        BT: [{ zhCN: "牛串", usEN: "Beef Teriyaki" }],
        SOS: [{ zhCN: "虾串", usEN: "Shrimp On Stick" }],
        FD: [{ zhCN: "炸包", usEN: "Fried Donut" }],
        SRT: [{ zhCN: "排骨尾", usEN: "Spare Rib tips" }],
        ST: [{ zhCN: "虾吐司", usEN: "Shrimp Toast" }],
        ...
        SS: [{ zhCN: "海鲜汤", usEN: "Seafood Soup" }, { zhCN: "四季豆虾", usEN: "Shrp w.String Bean" }],
        ...
        CM: [{ zhCN: "蘑菇鸡", usEN: "Chk w.Mushroom" }],
        LC: [{ zhCN: "柠檬鸡", usEN: "Lemon Chicken" }],
        ...
        HC: [{ zhCN: "蜜汁鸡", usEN: "Honey Chicken" }],
        ...
        VEFY: [{ zhCN: "菜蓉蛋", usEN: "Vege. Egg Foo Young" }],
