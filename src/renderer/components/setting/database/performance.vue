<template>
    <div>
        ...
        <div class="status">
            ...
            <h5>
                <span class="text">{{$t('database.warningAssert')}}</span>
                <span class="value">{{server.asserts.warning}}</span>
            </h5>
            <h5>
                <span class="text">{{$t('database.msgAssert')}}</span>
                <span class="value">{{server.asserts.msg}}</span>
            </h5>
            <h5>
                <span class="text">{{$t('database.userAssert')}}</span>
                <span class="value">{{server.asserts.msg}}</span>
            </h5>
        </div>
        <div class="status">
            ...
            <h5>
                <span class="text">{{$t('database.totalCreated')}}</span>
        ...
        <div class="status">
            ...
            <h5>
                <span class="text">{{$t('database.bytesIn')}}</span>
                <span class="value">{{server.network.bytesIn | mb}}</span>
            </h5>
            <h5>
                <span class="text">{{$t('database.bytesOut')}}</span>
                <span class="value">{{server.network.bytesOut | mb}}</span>
            </h5>
            <h5>
                <span class="text">{{$t('database.request')}}</span>
        ...
        <div class="status">
            ...
            <h5>
                <span class="text">{{$t('database.insert')}}</span>
                <span class="value">{{server.opcounters.insert}}</span>
            </h5>
            <h5>
                <span class="text">{{$t('database.query')}}</span>
                <span class="value">{{server.opcounters.query}}</span>
            </h5>
            <h5>
                <span class="text">{{$t('database.update')}}</span>
                <span class="value">{{server.opcounters.update}}</span>
            </h5>
            <h5>
                <span class="text">{{$t('database.delete')}}</span>
                <span class="value">{{server.opcounters.delete}}</span>
            </h5>
            <h5>
                <span class="text">{{$t('database.command')}}</span>
        ...
        <div class="status">
            ...
            <h5>
                <span class="text">{{$t('database.pageFaults')}}</span>
