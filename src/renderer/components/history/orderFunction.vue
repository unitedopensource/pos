<template>
    <div>
        ...
        <button class="btn" @click="discount" :disabled="disable || !op.modify.includes('discount')">
            <i class="fa fa-tag"></i>
        ...
        <button class="btn" @click="driver" :disabled="order.type !== 'DELIVERY' || !op.modify.includes('driver')">
